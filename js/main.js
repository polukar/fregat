...
/* harmony import */ var _project_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./project/slider */ "./src/js/project/slider.js");
/* harmony import */ var _project_map__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./project/map */ "./src/js/project/map.js");
/* harmony import */ var _project_map__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_project_map__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _project_tabs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./project/tabs */ "./src/js/project/tabs.js");
/* harmony import */ var _project_tabs__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_project_tabs__WEBPACK_IMPORTED_MODULE_5__);
...
var element = document.querySelectorAll('.js-mask-tel');
var maskOptions = {
...
if (element) {
  element.forEach(function (elem) {
    var mask = (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(elem, maskOptions);
  });
...
window.onload = function () {
  ...
  if (map) {
    var init = function init() {
      ...
      myMap.controls.remove("mapTools").remove("typeSelector").remove("searchControl").remove("trafficControl").remove("miniMap").remove("scaleLine").remove("routeEditor").remove("smallZoomControl");
...
var Slides = document.querySelectorAll('.partners__slider .swiper-slide');
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.partners__slider', {
  ...
  autoHeight: true,
  on: {
    slideChange: function slideChange(target) {
      console.log(target.activeIndex);

      if (target.activeIndex > 0) {
        Prev.classList.remove('--disabled');
      } else {
        Prev.classList.add('--disabled');
      }

      if (target.activeIndex == Slides.length - 1) {
...
var TABS_ITEMS = document.querySelectorAll('.category__btn');
var TABS = document.querySelectorAll('.category__tab');
